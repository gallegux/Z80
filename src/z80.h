...
class Z80
{
	...
	// el procesador notifica que ha recibido la interrupcion
...
public:
	...
	WORD getDE();
	WORD getHL();
    void set_PC_SP(u16 _pc, u16 _sp);
    void set_PC(u16 _pc);
...
private:
	...
	// funciones comunes a instrucciones
    void _inc8(BYTE *r8);
    void _dec8(BYTE *r8);
    void _push(WORD reg);
    void _pop(WORD* reg);
